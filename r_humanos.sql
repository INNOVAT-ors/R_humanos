...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2022 a las 03:48:16
...
CREATE TABLE `percepcion` (
  ...
  `descripcion` varchar(100) NOT NULL,
  `pornomina_personal` int(30) NOT NULL,
  `id_nomina` int(11) NOT NULL,
  `dia_por` int(45) DEFAULT NULL,
...
INSERT INTO `percepcion` (`idpercepcion`, `descripcion`, `pornomina_personal`, `id_nomina`, `dia_por`, `dia`, `mes`) VALUES
(1319, 'sueldo base', 1, 17, 1, 0, 0),
(1320, 'Aguinaldo', 1, 19, 1, 0, 0),
(1321, 'Aguinaldo23', 0, 16, 1, 21, 2);
...
--
-- Estructura de tabla para la tabla `per_puesto`
--

CREATE TABLE `per_puesto` (
  `idpercepcion` int(11) NOT NULL,
  `idPuesto` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `per_puesto`
--

INSERT INTO `per_puesto` (`idpercepcion`, `idPuesto`, `monto`, `idperiodo`) VALUES
(1321, 1, 1500, 6);
...
--
-- Indices de la tabla `per_puesto`
--
ALTER TABLE `per_puesto`
  ADD PRIMARY KEY (`idpercepcion`,`idPuesto`),
  ADD KEY `idpercepcion` (`idpercepcion`,`idPuesto`,`idperiodo`),
...
--
ALTER TABLE `nivelacademico`
  MODIFY `idNivelAcademico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `percepcion`
--
ALTER TABLE `percepcion`
  MODIFY `idpercepcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1322;
...
--
ALTER TABLE `periodo`
  MODIFY `idperiodo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
